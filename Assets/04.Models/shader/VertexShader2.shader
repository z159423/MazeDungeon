Shader "Custom/vertexShaderWithStencil2"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        CBUFFER_END
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                float _Property_4FB28363_Out_0 = Vector1_51D5406F;
                float _Split_A316918F_R_1 = IN.VertexColor[0];
                float _Split_A316918F_G_2 = IN.VertexColor[1];
                float _Split_A316918F_B_3 = IN.VertexColor[2];
                float _Split_A316918F_A_4 = IN.VertexColor[3];
                surface.Albedo = (IN.VertexColor.xyz);
                surface.Normal = IN.TangentSpaceNormal;
                surface.Emission = IsGammaSpace() ? float3(0, 0, 0) : SRGBToLinear(float3(0, 0, 0));
                surface.Metallic = 0;
                surface.Smoothness = _Property_4FB28363_Out_0;
                surface.Occlusion = 1;
                surface.Alpha = _Split_A316918F_A_4;
